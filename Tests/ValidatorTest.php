...
namespace Qubus\Test\Validation;
...
class ValidatorTest extends TestCase
{
    ...
    public function parseRuleProvider()
    {
        return [
            ...
            // required
            [
                ['foo' => 'foo', 'bar' => 1, 'baz' => 0, 'overtrue' => ['0']],
            ...
            [
                ...
                [
                    'foo' => 'regex:/^[a-z_13]+$/',
                    'bar' => 'regex:/^[_2\p{Han}]+$/u',
                    'baz' => 'regex:/^[\p{L}_0-9]+$/u',
                ],
                true,
            ],
            [
            ...
            [
                ...
                [
                    'foo' => 'before:2016-03-04 01:00:00',
                    'bar' => 'before:2016-05-06 12:06:01',
                    'baz' => 'before:2016-05-06 12:06:03',
                ],
                true,
            ],
            [
            ...
            [
                ['foo' => '2016-03-04', 'bar' => '2016-05-06 12:06', 'baz' => '2016-05-06 12:06:02'],
                [
                    'foo' => 'after:2016-03-03 23:59:59',
                    'bar' => 'after:2016-05-06 12:05:59',
                    'baz' => 'after:2016-05-06 12:06:01'
                ],
                true,
            ],
            [
    ...
    public function testSpanishTranslationCases($input, $rule, $status, $message = null)
    {
        ...
        $factory = new Factory(new EsEs($messages));
        $validator = $factory->make($input, $rule);
    ...
    public function parseSpanishRuleProvider()
    {
        return [
            ...
            [
                ...
                ['foo' => 'after:2016-03-04 00:00:00'],
                false,
                'El foo debe ser una fecha posterior a 2016-03-04 00:00:00.',
            ],
            // alpha
            [
                ['foo' => '123abcd'],
                ['foo' => 'alpha'],
                false,
                'El foo solo puede contener letras.',
            ],
            // alpha_dash
            [
                ['foo' => '123ab_cd.w'],
                ['foo' => 'alpha_dash'],
                false,
                'El foo solo puede contener letras, números y guiones.',
            ],
            // alpha_num
            [
                ['foo' => '123abcd.w'],
                ['foo' => 'alpha_num'],
                false,
                'El foo solo puede contener letras y números.',
            ],
        ];
    }
}
